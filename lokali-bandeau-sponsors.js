...
(function(){
  ...
  style.textContent =
    ...
    "text-decoration:none;padding:12px 16px;width:fit-content;max-width:100%}" +
    ".lka-carte-sp-inner:active{background:rgba(15,23,42,.02)}" +
    ".lka-carte-sp-inner.grand{padding:16px 20px}" +
    ...
    ".lka-carte-sp-txt{min-width:0;max-width:220px;border-left:1px solid rgba(15,23,42,.08);padding-left:14px}" +
  ...
  async function initBandeau() {
    ...
    var blocsHaut = construireBlocs(tous);
    blocsHaut.forEach(function(el, i) {
